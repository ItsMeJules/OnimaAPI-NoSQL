...
public class Cache<K, V> {
    ...
    private final Predicate<V> inUseCheck, postRemoval;
     ...
     */
    public Cache(final long retention, final Predicate<V> inUseCheck, final Predicate<V> postRemoval) {
        this.internal = new HashMap<K, V>();

        this.expiry = TreeMultimap.create((long1, long2) -> long1.compareTo(long2), (k1, k2) -> {return k1 == k2 || k1 != null && k1.equals(k2) ? 0 : 1;});
