...
public class CrateRemoveArgument extends BasicCommandArgument {

	public CrateRemoveArgument() {
		super("remove", OnimaPerm.ONIMAAPI_CRATE_REMOVE_ARGUMENT, new String[] {"delete"});
		
		usage = new JSONMessage("§7/crate " + name + " <crate>", "§d§oPermet de supprimer une crate.");
	}
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		crate.remove();
		sender.sendMessage("§dVous §7avez supprimé la crate " + crate.getName() + "§7.");
		return true;
	}
