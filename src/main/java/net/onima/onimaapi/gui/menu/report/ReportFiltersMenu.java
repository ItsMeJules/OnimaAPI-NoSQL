...
public class ReportFiltersMenu extends PacketMenu {
	...
	public ReportFiltersMenu(PlayerReportsMenu initialMenu, UUID playerUUID) {
		super("report_filters", "§6Filtrez les reports à votre guise.", MIN_SIZE * 2, false);
	...
	public void registerItems() {
		...
		buttons.put(5, new FilterButton(ReportFilter.getPlayerFilter(playerUUID, false), Material.GOLD_CHESTPLATE, 5));
		buttons.put(6, new FilterButton(ReportFilter.getPlayerFilter(playerUUID, true), Material.BOW, 6));
		buttons.put(7, new FilterButton(ReportFilter.WAITING_STATUS_REPORT_FILTER, Material.DISPENSER, 7));
		buttons.put(8, new FilterButton(ReportFilter.IN_PROGRESS_STATUS_REPORT_FILTER, Material.GOLD_NUGGET, 8));
		buttons.put(9, new FilterButton(ReportFilter.IMPORTANT_STATUS_REPORT_FILTER, Material.TNT, 9));
		buttons.put(10, new FilterButton(ReportFilter.TRUE_VERDICT_REPORT_FILTER, Material.INK_SACK, 10, 10));
		buttons.put(11, new FilterButton(ReportFilter.UNCERTAIN_VERDICT_REPORT_FILTER, Material.INK_SACK, 14, 11));
		buttons.put(12, new FilterButton(ReportFilter.FALSE_VERDICT_REPORT_FILTER, Material.INK_SACK, 1, 12));
